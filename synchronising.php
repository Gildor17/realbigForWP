			...
			if ( ! empty( $decodedToken['data'] ) ) {
				try {
					...
					if ( empty( $wpOptionsCheckerTokenValue ) ) {
						$wpdb->insert( $wpPrefix . 'realbig_settings', [ 'optionName'  => '_wpRealbigPluginToken',
						                                                 'optionValue' => $tokenInput
						] );
					} else {
						$wpdb->update( $wpPrefix . 'realbig_settings', [ 'optionName'  => '_wpRealbigPluginToken',
						                                                 'optionValue' => $tokenInput
					...
					if ( ! empty( $decodedToken['dataPush'] ) ) {
						...
						if ( empty( $wpOptionsCheckerPushStatus ) ) {
							$wpdb->insert( $wpPrefix . 'realbig_settings', [ 'optionName'  => 'pushStatus',
							                                                 'optionValue' => $decodedToken['dataPush']['pushStatus']
							] );
						} else {
							$wpdb->update( $wpPrefix . 'realbig_settings', [ 'optionName'  => 'pushStatus',
							                                                 'optionValue' => $decodedToken['dataPush']['pushStatus']
						...
						if ( empty( $wpOptionsCheckerPushCode ) ) {
							$wpdb->insert( $wpPrefix . 'realbig_settings', [ 'optionName'  => 'pushCode',
							                                                 'optionValue' => $decodedToken['dataPush']['pushCode']
							] );
						} else {
							$wpdb->update( $wpPrefix . 'realbig_settings', [ 'optionName'  => 'pushCode',
							                                                 'optionValue' => $decodedToken['dataPush']['pushCode']
							], [ 'optionName' => 'pushCode' ] );
						}
					}
					if ( ! empty( $decodedToken['domain'] ) ) {
						...
						if ( ! empty( $getDomain ) ) {
							$wpdb->update( $wpPrefix . 'realbig_settings', [ 'optionName'  => 'domain',
							                                                 'optionValue' => $decodedToken['domain']
							], [ 'optionName' => 'domain' ] );
						} else {
							$wpdb->insert( $wpPrefix . 'realbig_settings', [ 'optionName'  => 'domain',
							                                                 'optionValue' => $decodedToken['domain']
							] );
						}
					}
