...
//            }
    ...
    //						'<placeholderForAd><$1 $2 '.$thisElementName.' $3>', $editedContent);
    			...
    			$creatingJavascriptParserForContent = creatingJavascriptParserForContentFunction($fromDb, $usedBlocks);
	...
	function creatingJavascriptParserForContentFunction($fromDb, $usedBlocks)
    {
        try {
//	        $scriptingCode = '
//
...
';
	        ...
	        $scriptingCode .= PHP_EOL;
	        $scriptingCode .= 'testFuncInTestFile(blockSettingArray)</script>';
